...
👉 [Инструкция по приложению и настройке Karing](/Tunless/karing.html)
...
Инструкция по созданию иностранного аккаунта [скоро будет доступна](/Tunless/account.html).
...
> Мы рекомендуем **Karing** или **Hiddify**, т.к. в них, на данный момент, есть автоматическое переключение между протоколами и не нужно вручную перебирать какой сейчас работает и имеет наилучшее соединение
...
👉 [Подробная инструкция с картинками](/Tunless/karing.html)
...
4. Твой сервер появится в списке. Нажми на него, выбери протокол, чтобы он выделился (станет зеленым или серым или синим сбоку)
